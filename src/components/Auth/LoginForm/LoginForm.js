...
export default function LoginForm(props) {
  ...
  const [userActive, setUserActive] = useState(true); //Si usuario ha verficado la cuenta
  const [user, setUser] = useState(null); //Se guardará datos del usuario al hacer login
  ...
  const onSubmit = () => {
    setFormError({}); //Se limpia objeto errores
    let errors = {};
    let formOk = {};
